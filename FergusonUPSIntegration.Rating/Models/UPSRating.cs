...
namespace FergusonUPSIntegration.Rating.Models
{
    ...
    {
        public UPSRating(string rateType, Address origin, Address destination, Package package)
        {
        ...
        private static RateRequest CreateNewRateRequest(string rateType, Address origin, Address destination, Package package)
        {
